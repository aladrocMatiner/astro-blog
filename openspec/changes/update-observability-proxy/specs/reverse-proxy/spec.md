...
HAProxy MUST terminate TLS for `aladroc-test.io`, `www.aladroc-test.io`, and `grafana.aladroc-test.io` using certificates generated by a repeatable script checked into the repository.
